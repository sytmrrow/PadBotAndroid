...
import com.example.myapplication.databinding.ActivityFaceSearchBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SearchProcessBuilder faceProcessBuilder = new SearchProcessBuilder.Builder(this)
                ...
                .setProcessCallBack(new SearchProcessCallBack() {
                    ...
                    private static final long REDIRECT_COOLDOWN = 100;

                    @Override
                    public void onMostSimilar(String similar,float score, Bitmap bitmap) {
                        binding.searchTips.setText(similar);
                        if (score >= 0.85f && !isRedirected) {
                            long currentTime = System.currentTimeMillis();
                            if (currentTime - lastRedirectTime > REDIRECT_COOLDOWN) {
                                Intent intent = new Intent(FaceSearch1NActivity.this, ConfReserve.class);
                                intent.putExtra("matchedFace", similar);
